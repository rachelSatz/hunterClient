...
export class TransmissionCommentComponent implements OnInit {
  ...
  public remark: string;
    ...
    constructor(@Inject(MAT_DIALOG_DATA) public payment: any, private userSession: UserSessionService, 
    private processService: ProcessService, public dialogRef: MatDialogRef<TransmissionCommentComponent>) {}
