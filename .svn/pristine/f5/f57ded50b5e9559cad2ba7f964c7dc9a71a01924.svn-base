...
@Component({
  selector: 'RejectedEmployeeComponent',
  templateUrl: './rejected-employee.component.html',
  styleUrls: ['../../../shared/data-table/data-table.component.css', 
  '../feedback-employee-table/feedback-employee-table.componen.css',
  './rejected-employee.component.css'] 
})
export class RejectedEmployeeComponent extends DataTableComponent implements OnInit, OnDestroy {
  ...
  fetchItems(): void {
    this.feedbackService.getEmployeeFeedbacksApplications(this.searchCriteria).then(response => this.setItems(response));
  }
  ...
  openCommentDialog(employeeFeedback: EmployeeFeedback): void {
   
    const dialog = this.dialog.open(ApplicationCommentComponent, {
      data:{
      Comments:  employeeFeedback.Comments,
      IsDisabled:false 
    }
    });
  }
