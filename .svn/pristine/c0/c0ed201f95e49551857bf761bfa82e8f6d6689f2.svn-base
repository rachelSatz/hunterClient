...
export class EmployerService extends BaseHttpService {
  ...
  updateEmployer(employer: Employer,id: number, token: string): Promise<boolean> {
    return this.http.put(this.endPoint  + '/' + id, employer ,this.getTokenHeader(token)).toPromise()
